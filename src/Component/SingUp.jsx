...
const SingUp = ({ className }) => {
    ...
    return (
        <div className={`${className}`}>
            <div className="min-h-1/2 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-[#f3f3f4]">
                    ...
                    <form className="mt-8 space-y-4" action="#" onSubmit={handelSingUp} >
                        ...
                        <div className="rounded-md shadow-sm -space-y-px">
                            <div>
                                ...
                                <input value={data.name} onChange={(e) => setdata((prev) => ({ ...prev, name: e.target.value }))} id="full-name" name="name" type="text" className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md sm:text-sm" placeholder="Full Name" />
                            </div>
                        ...
                        <div>
                            <button type="submit" className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition duration-150 ease-in-out">
                                Sign Up
                            </button>
                        </div>
                    </form>
